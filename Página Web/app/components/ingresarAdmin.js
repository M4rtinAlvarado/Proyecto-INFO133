    ...
    return (
        <div className="form">
            ...
            <Accordion allowMultiple>
                <AccordionItem marginBottom={"10px"} borderRadius={"10px"} padding={"5px"} bgColor={"lightgray"}>
                    <AccordionButton marginLeft={"165px"}>
                        <Box as='span' flex='1' textAlign='left' >
                            Ingresar Empleado
                        </Box>
                        <AccordionIcon />
                    </AccordionButton>
                    <AccordionPanel marginLeft={"20px"}>
                        ...
                        <div className='div-default-R'>
                            ...
                            <div className="div-default-C">
                                ...
                                <select name="id_cargo" id="id_cargo" required className="form-client-select" onChange={(e) => handleSelect(e.target.id)} value={cargo}>
                                    ...
                                    {cargos.map((x) => (
                                        <option value={x.id_cargo}>{x.nombre}</option>
                                    ))}
                                </select>
                            </div>
                        </div>
                        ...
                        <div className='div-default-C'>
                            <div className="div-buttons">
                                <div>
                                    <button className="form-button" onClick={nuevoEmpleado}>Ingresar</button>
                                </div>
                            </div>
                        </div>
                    </AccordionPanel>
                ...
                <AccordionItem marginBottom={"10px"} borderRadius={"10px"} padding={"5px"} bgColor={"lightgray"}>
                    ...
                    <AccordionPanel marginLeft={"20px"}>
                        ...
                        <div className='div-default-C'>
                            <div className="div-buttons">
                                <div>
                                    <button className="form-button" onClick={stock}>Ingresar</button>
                                </div>
                            </div>
                        </div>
                    </AccordionPanel>
