        ...
        <div>
            <div className="form">
                ...
                <div className="form-div">
                    ...
                    <button className="form-button" onClick={addSeleccion}>Añadir Producto</button>
                </div>
                ...
                <div className="div-buttons">
                    ...
                    <div>
                        <button className="form-ingresar-button" onClick={insertProducts}>Ingresar Venta</button>
                    </div>
                </div>
            </div>
        </div >
