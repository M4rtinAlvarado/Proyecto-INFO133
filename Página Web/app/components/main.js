        ...
        <div className="div-ingresar" id="div-ingresar">
          <h2>Ingresar como:</h2>
            <Link href={`adminPage/${sede}`}>
              <Button margin={"20px"} width={"300px"} height={"100px"} bgColor={"#f0dac5"} >Administrador</Button>
            </Link>
            <Link href={`empleadoPage/${sede}`}>
              <Button margin={"20px"} width={"300px"} height={"100px"} bgColor={"#f0dac5"}>Empleado</Button>
            </Link>
        </div>
